...
void tag_processor_v1::process_xml(xml::node *node, const scope& scope, fs::path dir, basic_webapp& webapp)
{
...
void tag_processor_v1::process_tag(const std::string& tag, xml::element *node, const scope& scope, fs::path dir, basic_webapp& webapp)
{
...
void tag_processor_v1::process_url(xml::element *node, const scope& scope, fs::path dir, basic_webapp& webapp)
{
...
void tag_processor_v1::process_param(xml::element *node, const scope& scope, fs::path dir, basic_webapp& webapp)
{
