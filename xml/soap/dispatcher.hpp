...
struct call_helper
{
	...
	struct traits<void (C::*)(const T1&, const T2&, R&)>
	{
		typedef typename call<C,void(const T1&, const T2&, R&)> call_type;
	}
};
...
//					}
	...
	void			register_soap_call(
						...
						const char*		arg2)
					{
						...
						actions.push_back(
							new call<Derived,>(action, static_cast<Derived*>(this), call_, names));
					}
