...
The XML part of libzeep has been split off in version 7 and libzeep now uses `libzeem <https://forge.hekkelman.net/maarten/libzeem>` for the manipulation of XML.
