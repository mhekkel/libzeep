...
constexpr int klibzeepBuildNumber = 1639;
constexpr const char klibzeepRevisionGitTag[] = "651df28*";
constexpr const char klibzeepRevisionDate[] = "2024-03-12T14:56:04Z";
...
class version_info_libzeep_impl : public version_info_v1_1::version_info<version_info_libzeep_impl>
{
  public:
	version_info_libzeep_impl()
		: version_info(klibzeepProjectName, klibzeepVersionNumber, klibzeepBuildNumber, klibzeepRevisionGitTag, klibzeepRevisionDate, false)
	{
	}
};
